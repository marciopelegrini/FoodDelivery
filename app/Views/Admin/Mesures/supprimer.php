            ...
            <div class="col-lg-8 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?= form_open("admin/mesures/supprimer/$mesure->id"); ?>

                        <div class="alert alert-warning" role="alert">
                            <strong>Attention</strong>Voulez-vous vraiment supprimer cette mesure ?
                            <strong><?= esc($mesure->nom); ?> ?</strong>
                        </div>
                        ...
                        <a href="<?= site_url("admin/mesures/show/$mesure->id"); ?>" class="btn btn-info btn-sm">
