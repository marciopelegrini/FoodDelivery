    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex justify-content-center">
            <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                <a class="navbar-brand brand-logo"><img src="<?= site_url('admin/') ?>images/logo.png"
                                                                          style="width:50px;height:50px;" alt="logo"/></a>
                <a class="navbar-brand brand-logo-mini"><img src="<?= site_url('admin/') ?>images/logo.png" alt="logo"/></a>
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= site_url('admin/users') ?>">
                        ...
                        <span class="menu-title">Usagers</span>
                    </a>
                </li>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    ...
                    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="https://www.bootstrapdash.com/"
                                                                                                      target="_blank">Bootstrap dashboard template</a> from Bootstrapdash.com</span>
                </div>
            </footer>
            <!-- partial -->
        </div>
